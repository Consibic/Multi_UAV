...
class SlungPayloadVariableLengthSystem:
    def __init__(self, x_init):
        ...
        self.num_dim_x = 36  # number of dimensions in state vector x
        self.num_dim_control = 4  # number of dimensions in control vector u
        
        # Slung payload parameters
        self.g = 9.81
        self.m_p = 0.7  # mass of the payload
        ...
        # Kinematics
        self.Z = get_Z(self.r_tilde, self.l)
        self.n = get_n(self.r_tilde)
        self.n_T = self.n.transpose(1, 2)
        self.B = get_B(self.r_tilde, self.l)
        self.B_T = self.B.transpose(1, 2)
        self.B_dot = get_B_dot(self.r_tilde, self.v_tilde, self.l)
    ...
    def update_state(self, x):
        ...
        # States
        x_p_x, x_p_y, x_p_z, phi, theta, psi, r_1_x, r_1_y, r_2_x, r_2_y, r_3_x, r_3_y, v_p_x, v_p_y, v_p_z, omega_phi, omega_theta, omega_psi, v_q1_x, v_q1_y, v_q1_z, v_q2_x, v_q2_y, v_q2_z, v_q3_x, v_q3_y, v_q3_z = [x[:, i, 0] for i in range(self.num_dim_x)]
        ...
        self.v_q = torch.stack([v_q1_x, v_q1_y, v_q1_z, v_q2_x, v_q2_y, v_q2_z, v_q3_x, v_q3_y, v_q3_z], dim=1).unsqueeze(-1)
